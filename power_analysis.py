...
# the above part works... Something's wrong with the bottom part which I adapted from something I found on stackxchange.
#And this is not even taking into account that I probably have paired-end reads and therefore want to keep the pairs together despite random sampling.
